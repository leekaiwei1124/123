    ...
    41: function (t, e) {
        gapi.analytics.ready(function () {
            ...
            function n(n) {
                ...
                if ("yesterday" == n)
                    return a(1);
                if ("firstDayOfMonth" == n)
                    return r = new Date,
                        i = r.getFullYear().toString().padStart(4, 0),
                        o = (r.getMonth() + 1).toString().padStart(2, 0),
                        "".concat(i, "-").concat(o, "-01");
            ...
            gapi.analytics.createComponent("DateRangeSelector", {
                execute: function () {
                    var t = this.get();
                    t["start-date"] = t["start-date"] || "7daysAgo",
                        t["end-date"] = t["end-date"] || "yesterday",
                        this.container = "string" == typeof t.container ? document.getElementById(t.container) : t.container,
                        t.template && (this.template = t.template),
                        this.container.innerHTML = this.template;
                    var e = this.container.querySelectorAll("input");
                    return this.startDateInput = e[0],
                        this.startDateInput.value = n(t["start-date"]),
                        this.endDateInput = e[1],
                        this.endDateInput.value = n(t["end-date"]),
                        this.setValues(),
                        this.setMinMax(),
